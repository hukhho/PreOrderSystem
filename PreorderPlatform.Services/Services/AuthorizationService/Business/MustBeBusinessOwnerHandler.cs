...
{
    public class MustBeBusinessOwnerHandler : AuthorizationHandler<MustBeBusinessOwnerRequirement>
    {
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, MustBeBusinessOwnerRequirement requirement)
        {
            ...
            using (var scope = _serviceProvider.CreateScope())
            {
                ...
                {
                    throw new AuthorizationException($"User {userId} is not the owner of business {businessId}.");
                }
            }
